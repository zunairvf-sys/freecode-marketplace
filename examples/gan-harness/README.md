...
```bash
# In freecode Code interactive mode:
...
freecode -p --model opus "$(cat agents/gan-planner.md)
...
freecode -p --model opus "$(cat agents/gan-generator.md)
...
freecode -p --model opus "$(cat agents/gan-evaluator.md)
