# User-Level freecode.md Example

This is an example user-level freecode.md file. Place at `~/.freecode/freecode.md`.
...
You are freecode Code. I use specialized agents and skills for complex tasks.
...
Detailed guidelines are in `~/.freecode/rules/`:
