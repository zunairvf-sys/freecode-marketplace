...
Use this playbook when release copy or roadmap text mentions FreeCode Tools
...
2. Check the current repo and public listing surfaces:
   - `gh api repos/FreeCode-Tools/FreeCode-Tools`
...
- `rg -n "billing|Billing|Marketplace|marketplace|subscription|seat|entitlement|plan" README.md docs/releases/2.0.0-rc.1 docs/FreeCode-2.0-GA-ROADMAP.md`
- `gh api repos/FreeCode-Tools/FreeCode-Tools`
- Manual live check of `https://github.com/marketplace/ecc-tools`
- `npx --yes markdownlint-cli docs/releases/2.0.0-rc.1/*.md docs/FreeCode-2.0-GA-ROADMAP.md`
- `git diff --check`
