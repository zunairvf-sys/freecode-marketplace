...
When saving campaign assets, the convention is `.freecode/campaigns/{campaign-name}/`:

```
.freecode/campaigns/product-launch/
├── positioning.md
├── landing-page.md
├── email-sequence.md
├── social-posts.md
...
```
/marketing-campaign review .freecode/campaigns/the-key/landing-page.md
```
