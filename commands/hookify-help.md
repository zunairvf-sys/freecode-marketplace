...
Hookify creates rule files that integrate with freecode Code's hook system to prevent unwanted behaviors.
...
Files are stored as `.freecode/hookify.{name}.local.md`:
