...
Write the full plan document using the template below. Save to `.freecode/PRPs/plans/{kebab-case-feature-name}.plan.md`.

Create the directory if it doesn't exist:
```bash
mkdir -p .freecode/PRPs/plans
```
...
```
.freecode/PRPs/plans/{kebab-case-feature-name}.plan.md
```
...
- **File**: .freecode/PRPs/plans/{kebab-case-feature-name}.plan.md
- **Source PRD**: [path or "N/A"]
...
> Next step: Run `/prp-implement .freecode/PRPs/plans/{name}.plan.md` to execute this plan.
```
