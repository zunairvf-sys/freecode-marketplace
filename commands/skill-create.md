...
Analyze your repository's git history to extract coding patterns and generate SKILL.md files that teach freecode your team's practices.
...
3. **Generates SKILL.md** - Creates valid freecode Code skill files
...
*Part of [Everything freecode Code](https://github.com/freecode/marketplace)*
