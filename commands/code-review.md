...
1. **Project rules** — Read `freecode.md`, `.freecode/docs/`, and any contributing guidelines
2. **Planning artifacts** — Check `.freecode/prds/`, `.freecode/plans/`, `.freecode/reviews/`, and legacy `.freecode/PRPs/{prds,plans,reports,reviews}/` for context related to this PR
...
Create review artifact at `.freecode/reviews/pr-<NUMBER>-review.md` unless the repo already uses legacy `.freecode/PRPs/reviews/` for this workstream:
...
Artifacts:
  Review: .freecode/reviews/pr-<NUMBER>-review.md
  GitHub: <PR URL>
