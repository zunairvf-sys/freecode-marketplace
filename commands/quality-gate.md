---
description: Run the FreeCode quality pipeline for a file or project scope and report remediation steps.
---

# Quality Gate Command

Run the FreeCode quality pipeline on demand for a file or project scope.
