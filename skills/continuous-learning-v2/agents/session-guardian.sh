...
# Called by observer-loop.sh before spawning any freecode session.
#
# Config (env vars, all optional):
#   OBSERVER_INTERVAL_SECONDS    default: 300   (per-project cooldown)
#   OBSERVER_LAST_RUN_LOG        default: ~/.freecode/observer-last-run.log
...
LOG_PATH="${OBSERVER_LAST_RUN_LOG:-$HOME/.freecode/observer-last-run.log}"
