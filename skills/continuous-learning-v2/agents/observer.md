...
A background agent that analyzes observations from freecode Code sessions to detect patterns and create instincts.
...
### 1. User Corrections
When a user's follow-up message corrects freecode's previous action:
