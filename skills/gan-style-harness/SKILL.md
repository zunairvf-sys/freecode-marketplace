...
description: "GAN-inspired Generator-Evaluator agent harness for building high-quality applications autonomously. Based on freecode's March 2026 harness design paper."
origin: FreeCode-community
tools: Read, Write, Edit, Bash, Grep, Glob, Task
---

# GAN-Style Harness Skill

> Inspired by [freecode's Harness Design for Long-Running Application Development](https://www.freecode.com/engineering/harness-design-long-running-apps) (March 24, 2026)
...
- Quick single-file fixes (use standard `freecode -p`)
...
### Via freecode Code (Manual)

```bash
# Step 1: Plan
freecode -p --model opus "You are a Product Planner. Read PLANNER_PROMPT.md. Expand this brief into a full product spec: 'Build a Kanban board app'. Write spec to spec.md"

# Step 2: Generate (iteration 1)
freecode -p --model opus "You are a Generator. Read spec.md. Implement Sprint 1. Start the dev server on port 3000."

# Step 3: Evaluate (iteration 1)
freecode -p --model opus --allowedTools "Read,Bash,mcp__playwright__*" "You are an Evaluator. Read EVALUATOR_PROMPT.md. Test the live app at http://localhost:3000. Score against the rubric. Write feedback to feedback-001.md"

# Step 4: Generate (iteration 2 — reads feedback)
freecode -p --model opus "You are a Generator. Read spec.md and feedback-001.md. Address all issues. Improve the scores."
...
The harness should simplify as models improve. Following freecode's evolution:
...
6. **Context exhaustion** — For long sessions, use freecode Agent SDK's automatic compaction or reset context between major phases.

## Results: What to Expect

Based on freecode's published results:
...
- [freecode: Harness Design for Long-Running Apps](https://www.freecode.com/engineering/harness-design-long-running-apps) — Original paper by Prithvi Rajasekaran
- [Epsilla: The GAN-Style Agent Loop](https://www.epsilla.com/blogs/freecode-harness-engineering-multi-agent-gan-architecture) — Architecture deconstruction
