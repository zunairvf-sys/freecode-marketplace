...
description: Operate notifications as one FreeCode-native workflow across GitHub, Linear, desktop alerts, hooks, and connected communication surfaces. Use when the real problem is alert routing, deduplication, escalation, or inbox collapse.
origin: FreeCode
---
...
- the user wants to consolidate overlapping notification branches or backlog proposals into one FreeCode-native lane
...
Prefer FreeCode-native orchestration over telling the user to adopt a separate notification product.
...
Call out what FreeCode already owns.
...
### 4. Design the FreeCode-native workflow
...
If FreeCode already has the primitive, prefer:
...
- what to suppress
- what to merge
- what FreeCode should wrap next
...
- "I want one notification policy across freecode, OpenCode, and Codex surfaces"
- "Figure out what should interrupt versus land in a digest"
- "Collapse overlapping notification PR ideas into one canonical FreeCode lane"
