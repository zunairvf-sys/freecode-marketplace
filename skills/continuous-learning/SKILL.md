...
Automatically evaluates freecode Code sessions on end to extract reusable patterns that can be saved as learned skills.

## When to Activate

- Setting up automatic pattern extraction from freecode Code sessions
- Configuring the Stop hook for session evaluation
- Reviewing or curating learned skills in `~/.freecode/skills/learned/`
...
3. **Skill Extraction**: Saves useful patterns to `~/.freecode/skills/learned/`
...
```json
{
  ...
  "auto_approve": false,
  "learned_skills_path": "~/.freecode/skills/learned/",
  "patterns_to_detect": [
    "error_resolution",
    "user_corrections",
    "workarounds",
...
Add to your `~/.freecode/settings.json`:
...
- [The Longform Guide](https://x.com/freecode) - Section on continuous learning
