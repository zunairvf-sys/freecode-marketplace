...
description: >-
  Analyze raw prompts, identify intent and gaps, match FreeCode components
...
Analyze a draft prompt, critique it, match it to FreeCode ecosystem components,
...
- User says "what's the best way to ask freecode Code to..."
- User says "优化prompt", "改进prompt", "怎么写prompt", "帮我优化这个指令"
- User pastes a draft prompt and asks for feedback or enhancement
- User says "I don't know how to prompt for this"
- User says "how should I use FreeCode for..."
...
- User is asking about FreeCode configuration (use `configure-ecc` instead)
...
1. Check if a `freecode.md` exists in the working directory — read it for project conventions
...
### Phase 3: FreeCode Component Matching

Map intent + scope + tech stack (from Phase 0) to specific FreeCode components.
...
### Section 2: Recommended FreeCode Components
...
A compact version for experienced FreeCode users. Vary by intent type:
...
- "Optimize this prompt for FreeCode"
- "Rewrite this prompt so freecode Code uses the right commands"
- "帮我优化这个指令"
- "How should I prompt FreeCode for this task?"
...
|-----------|------------------|
| `configure-ecc` | User hasn't set up FreeCode yet |
