...
Do **not** write ad-hoc notes to `~/.freecode/notes` or other shadow paths from this skill.
...
```text
Should we ship FreeCode 2.0 as alpha now, or hold until the control-plane UI is more complete?
```
