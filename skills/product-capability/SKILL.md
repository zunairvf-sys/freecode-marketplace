...
description: Translate PRD intent, roadmap asks, or product discussions into an implementation-ready capability plan that exposes constraints, invariants, interfaces, and unresolved decisions before multi-service work starts. Use when the user needs an FreeCode-native PRD-to-SRS lane instead of vague planning prose.
origin: FreeCode
---
...
If useful, point to the next FreeCode-native lane:
...
HANDOFF
- what should happen next and which FreeCode lane should take it
```
...
- The resulting plan is reusable across freecode Code, Codex, Cursor, OpenCode, and FreeCode 2.0 planning surfaces.
