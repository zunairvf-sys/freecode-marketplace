...
resp = requests.get(
    ...
    headers=headers,
    params={"query": "freecode code", "max_results": 10}
)
tweets = resp.json()
```
...
resp = oauth.post(
    ...
    json={"text": "Hello from freecode Code"}
)
...
resp = requests.get(
    ...
    headers=headers,
    params={
        "query": "from:freecode -is:retweet",
        "max_results": 10,
...
resp = requests.get(
    ...
    headers=headers,
    params={
        "query": "from:freecode -is:retweet -is:reply",
        "max_results": 25,
        "tweet.fields": "created_at,public_metrics",
    }
)
...
```python
resp = requests.get(
    "https://api.x.com/2/users/by/username/freecode",
    headers=headers,
