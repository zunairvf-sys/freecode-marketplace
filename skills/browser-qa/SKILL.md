...
Uses the browser automation MCP (freecode-in-chrome, Playwright, or Puppeteer) to interact with live pages like a real user.
...
- `mChild__freecode-in-chrome__*` tools (preferred — uses your actual Chrome)
