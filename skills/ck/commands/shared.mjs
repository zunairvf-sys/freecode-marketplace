...
export const CK_HOME          = resolve(homedir(), '.freecode', 'ck');
...
export const SKILL_FILE       = resolve(homedir(), '.freecode', 'skills', 'ck', 'SKILL.md');
...
export function nativeMemoryDir(absolutePath) {
  ...
  return resolve(homedir(), '.freecode', 'projects', encoded, 'memory');
}
