...
Intercept the response flow to offer the user a choice about response depth **before** freecode answers.
...
Standalone skill from [TBA — Token Budget Advisor for freecode Code](https://github.com/Xabilimon1/Token-Budget-Advisor-freecode-Code-).
