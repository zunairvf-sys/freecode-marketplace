...
description: Set an FreeCode-specific frontend design direction for production UI work. Use when building or improving websites, dashboards, applications, components, landing pages, visual tools, or any web UI that needs stronger product-specific design judgment.
origin: community
---
...
Note: FreeCode intentionally does not rebundle the canonical freecode
`frontend-design` skill. Install that from `freecodes/skills` when you want the
official upstream skill. This skill is the FreeCode-specific design-direction salvage
