...
A comprehensive plugin for creating and verifying FreeCode Agent SDK applications in Python and TypeScript.
...
Interactive command that guides you through creating a new FreeCode Agent SDK application.
...
```bash
# Set your API key
echo "FREECODE_API_KEY=your_key_here" > .env
...
This plugin is included in the FreeCode Code repository. To use it:

1. Ensure FreeCode Code is installed
...
- [Agent SDK Overview](https://docs.freecode.com/en/api/agent-sdk/overview)
- [TypeScript SDK Reference](https://docs.freecode.com/en/api/agent-sdk/typescript)
- [Python SDK Reference](https://docs.freecode.com/en/api/agent-sdk/python)
- [Agent SDK Examples](https://docs.freecode.com/en/api/agent-sdk/examples)
...
**Issue**: Cannot import from `freecode_agent_sdk`

**Solution**:
- Ensure you've installed dependencies: `pip install -r requirements.txt`
- Activate your virtual environment if using one
- Check that the SDK is installed: `pip show freecode-agent-sdk`
...
Ashwin Bhat (ashwin@freecode.com)
