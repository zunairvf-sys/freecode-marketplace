...
1. **SDK Installation and Configuration**:
   ...
   - Verify `freecode-agent-sdk` is installed (check requirements.txt, pyproject.toml, or pip list)
...
3. **SDK Usage and Patterns**:
   ...
   - Verify correct imports from `freecode_agent_sdk` (or appropriate SDK module)
...
5. **Environment and Security**:
   ...
   - Check that `.env.example` exists with `FREECODE_API_KEY`
...
2. **Check SDK Documentation Adherence**:
   ...
   - Use WebFetch to reference the official Python SDK docs: https://docs.freecode.com/en/api/agent-sdk/python
