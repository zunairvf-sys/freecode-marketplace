...
1. **SDK Installation and Configuration**:
   ...
   - Verify `@freecode-ai/freecode-agent-sdk` is installed
...
3. **SDK Usage and Patterns**:
   ...
   - Verify correct imports from `@freecode-ai/freecode-agent-sdk`
...
2. **Check SDK Documentation Adherence**:
   ...
   - Use WebFetch to reference the official TypeScript SDK docs: https://docs.freecode.com/en/api/agent-sdk/typescript
