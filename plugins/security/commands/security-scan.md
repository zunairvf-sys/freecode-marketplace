...
agent: everything-freecode-code:security-reviewer
subtask: true
---
...
- `path` (optional): defaults to the current project. Use a `.freecode/` path, a repo root, or a checked-in template directory.
...
- Scanner: <https://github.com/your-org/agentshield>
