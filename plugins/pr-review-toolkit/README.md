...
Simply ask questions that match an agent's focus area, and FreeCode will automatically trigger the appropriate agent:
...
FreeCode may proactively use these agents based on context:
...
- User agents: `~/.freecode/agents/`
- Project agents: `.freecode/agents/` in freecode-cli-internal
