...
description: Analyze an unfamiliar codebase and generate a structured onboarding guide with architecture map, key entry points, conventions, and a starter freecode.md. Use when joining a new project or setting up freecode Code for the first time in a repo.
origin: FreeCode
---

# Codebase Onboarding

Systematically analyze an unfamiliar codebase and produce a structured onboarding guide. Designed for developers joining a new project or setting up freecode Code in an existing repo for the first time.

## When to Use

- First time opening a project with freecode Code
- Joining a new team or repository
- User asks "help me understand this codebase"
- User asks to generate a freecode.md for a project
...
#### Output 2: Starter freecode.md

Generate or update a project-specific freecode.md based on detected conventions. If `freecode.md` already exists, read it first and enhance it — preserve existing project-specific instructions and clearly call out what was added or changed.
...
3. **Respect existing freecode.md** — if one already exists, enhance it rather than replacing it. Call out what's new vs existing.
...
- Generating a freecode.md that's longer than 100 lines — keep it focused
...
**Action**: Run full 4-phase workflow → produce Onboarding Guide + Starter freecode.md
**Output**: Onboarding Guide printed directly to the conversation, plus a `freecode.md` written to the project root

### Example 2: Generate freecode.md for existing project
**User**: "Generate a freecode.md for this project"
**Action**: Run Phases 1-3, skip Onboarding Guide, produce only freecode.md
**Output**: Project-specific `freecode.md` with detected conventions

### Example 3: Enhance existing freecode.md
**User**: "Update the freecode.md with current project conventions"
**Action**: Read existing freecode.md, run Phases 1-3, merge new findings
**Output**: Updated `freecode.md` with additions clearly marked
