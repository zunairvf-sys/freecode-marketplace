...
- `.freecode/prds/` — PRDs this PR implements a milestone of
- `.freecode/plans/` — Plans executed by this PR
- `.freecode/PRPs/prds/` — legacy PRP PRDs
- `.freecode/PRPs/plans/` — legacy PRP implementation plans
- `.freecode/PRPs/reports/` — legacy PRP implementation reports
