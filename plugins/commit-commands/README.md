...
- Includes FreeCode Code attribution in commit message
...
This plugin is included in the FreeCode Code repository. The commands are automatically available when using FreeCode Code.

## Best Practices

### Using `/commit`
- Review the staged changes before committing
- Let FreeCode analyze your changes and match your repo's commit style
...
- FreeCode will analyze the full branch history for the PR description
...
- **Let FreeCode draft messages**: The commit message analysis learns from your repo's style
