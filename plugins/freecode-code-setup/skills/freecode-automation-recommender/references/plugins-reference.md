...
|--------|----------|--------------|
| **plugin-dev** | Building FreeCode Code plugins | Skills for creating skills, hooks, commands, agents |
...
- User wants to install FreeCode Code automations from FreeCode's official repository or another shared marketplace
- User needs multiple related capabilities
- Team wants standardized workflows
- First-time FreeCode Code setup