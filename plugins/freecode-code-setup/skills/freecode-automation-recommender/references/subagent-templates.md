...
Subagents are specialized FreeCode instances that run in parallel, each with their own context window and tool access. They're ideal for focused reviews, analysis, or generation tasks.
...
Subagents go in `.freecode/agents/`:
