# FreeCode Code Setup Plugin

Analyze codebases and recommend tailored FreeCode Code automations - hooks, skills, MCP servers, and more.

## What It Does

FreeCode uses this skill to scan your codebase and recommend the top 1-2 automations in each category:
