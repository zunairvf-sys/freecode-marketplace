...
#   bash "${FREECODE_PLUGIN_ROOT}/hooks/sg-python.sh" \
#        "${FREECODE_PLUGIN_ROOT}/hooks/security_reminder_hook.py"
set -e
...
# session restarts. See freecodes/freecode-plugins-official#2043.
#
...
# True iff arg is a "M.m" version string >= 3.10. freecode_agent_sdk requires
...
# See freecodes/freecode-plugins-official#2071.
is_sdk_compatible() {
    case "$1" in
