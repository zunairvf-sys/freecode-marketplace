...
| Port/Rebuild | useful idea, but should be manually re-landed inside FreeCode |
...
- External-source features should be rebuilt inside FreeCode when they are valuable but not self-contained
...
- "Map GitHub issues into our FreeCode 1.x and FreeCode 2.0 program lanes"
