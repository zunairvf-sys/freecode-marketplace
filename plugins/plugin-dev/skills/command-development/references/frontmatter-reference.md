...
**Purpose:** Specify which FreeCode model executes the command
...
- FreeCode can invoke programmatically
...
**Best practices:**
- Use sparingly (limits FreeCode's autonomy)
...
**Invalid model name:**
```yaml
model: gpt4  # ❌ Not a valid FreeCode model
```
