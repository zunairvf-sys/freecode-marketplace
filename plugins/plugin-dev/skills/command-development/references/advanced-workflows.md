...
Deployment state saved to `.freecode/deployment-state.local.md`:
...
Reading deployment state from `.freecode/deployment-state.local.md`...
...
```markdown
.freecode/plugin-name-workflow.local.md:
...
Reading workflow state from .freecode/plugin-name-workflow.local.md...

Current stage: @.freecode/plugin-name-workflow.local.md
...
State file: @.freecode/plugin-name-workflow.local.md
...
Creating: .freecode/feature-complete.flag
...
if [ -f .freecode/feature-complete.flag ]; then
...
if [ -f .freecode/deployment.lock ]; then
...
!`validate.sh`
echo "checkpoint:validation" >> .freecode/deployment-checkpoints.log

## Checkpoint 2: Build
!`build.sh`
echo "checkpoint:build" >> .freecode/deployment-checkpoints.log

## Checkpoint 3: Deploy
!`deploy.sh`
echo "checkpoint:deploy" >> .freecode/deployment-checkpoints.log
...
Written to .freecode/deployment-state.local.md
...
Reading state: @.freecode/deployment-state.local.md
...
rm .freecode/deployment-state.local.md
