...
**Important:** All examples below are written as instructions FOR FreeCode (agent consumption), not messages TO users. Commands tell FreeCode what to do, not tell users what will happen.

## Example 1: Code Review Command

**File:** `.freecode/commands/review.md`
...
**File:** `.freecode/commands/security-review.md`
...
**File:** `.freecode/commands/test-file.md`
...
**File:** `.freecode/commands/document.md`
...
**File:** `.freecode/commands/git-status.md`
...
**File:** `.freecode/commands/deploy.md`
...
**File:** `.freecode/commands/compare-files.md`
...
**File:** `.freecode/commands/quick-fix.md`
...
**File:** `.freecode/commands/research.md`
...
**File:** `.freecode/commands/explain.md`
