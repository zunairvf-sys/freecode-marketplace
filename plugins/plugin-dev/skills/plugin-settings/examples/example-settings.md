...
**.freecode/experimental-features.local.md:**
...
# Read settings
FRONTMATTER=$(sed -n '/^---$/,/^---$/{ /^---$/d; p; }' ".freecode/my-plugin.local.md")
...
```bash
# Edit settings
vim .freecode/my-plugin.local.md

# Changes take effect after restart
exit  # Exit FreeCode Code
freecode  # Restart
```

Changes require FreeCode Code restart - hooks can't be hot-swapped.
