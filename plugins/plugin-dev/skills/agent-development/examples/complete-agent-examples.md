...
3. Check adherence to project best practices and coding standards from FREECODE.md
...
5. **Best Practices**:
   - Follow project-specific standards from FREECODE.md
...
- Missing context (no FREECODE.md): Apply general best practices
