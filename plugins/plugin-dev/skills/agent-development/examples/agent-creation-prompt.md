...
Use this template to generate agents using FreeCode with the agent creation system prompt.
...
Send this to FreeCode (with the agent-creation-system-prompt loaded):
...
### Step 3: FreeCode Returns JSON

FreeCode will return:
...
Tell FreeCode when the agent should activate:
...
- **Comprehensive**: FreeCode includes edge cases and quality checks
