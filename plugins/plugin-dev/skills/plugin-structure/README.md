...
Comprehensive guidance on FreeCode Code plugin architecture, directory layout, and best practices.
...
- Portable path references with `${FREECODE_PLUGIN_ROOT}`
...
- Ask about "${FREECODE_PLUGIN_ROOT}" usage
...
FreeCode loads references and examples only as needed based on the task.
