...
# Set up environment
export FREECODE_PROJECT_DIR="${FREECODE_PROJECT_DIR:-/tmp/test-project}"
export FREECODE_PLUGIN_ROOT="${FREECODE_PLUGIN_ROOT:-$(pwd)}"
export FREECODE_ENV_FILE="${FREECODE_ENV_FILE:-/tmp/test-env-$$}"

if [ "$VERBOSE" = true ]; then
  echo "Environment:"
  echo "  FREECODE_PROJECT_DIR=$FREECODE_PROJECT_DIR"
  echo "  FREECODE_PLUGIN_ROOT=$FREECODE_PLUGIN_ROOT"
  echo "  FREECODE_ENV_FILE=$FREECODE_ENV_FILE"
  echo ""
fi
...
if [ -f "$FREECODE_ENV_FILE" ]; then
  echo ""
  echo "Environment file created:"
  cat "$FREECODE_ENV_FILE"
  rm -f "$FREECODE_ENV_FILE"
fi
