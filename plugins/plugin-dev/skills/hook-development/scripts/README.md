...
Tests individual hook scripts with sample input before deploying to FreeCode Code.
...
**Features:**
- Sets up proper environment variables (FREECODE_PROJECT_DIR, FREECODE_PLUGIN_ROOT)
...
- Path in hooks.json is correct (use `${FREECODE_PLUGIN_ROOT}`)
