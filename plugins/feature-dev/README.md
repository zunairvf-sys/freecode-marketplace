...
FreeCode: Let me understand what you need...
...
- FreeCode reads all identified files to build deep understanding
...
**Focus areas:**
- Project guideline compliance (FREECODE.md)
- Bug detection
- Code quality issues
...
Sid Bidasaria (sbidasaria@freecode.com)
