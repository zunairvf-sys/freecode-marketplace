 ...
 *
 * Plus one gmail_api_<resource>_<method> tool per Gmail API v1 method
 * (see ROUTES below / servergmail.md) for full REST parity — e.g.
 * gmail_api_messages_list, gmail_api_drafts_create,
 * gmail_api_settings_sendAs_list, gmail_api_threads_modify, etc.
 *
 * Setup:
...
// --- Full Gmail API v1 parity routes (see servergmail.md) ---
// One entry per Gmail API v1 REST method. Paths omit the "/gmail/v1" prefix
// (gmailRequest() already prefixes GMAIL_API). {userId} defaults to "me".
const ROUTES = [
  // v1.users
  { resource: "v1.users", methodName: "getProfile", http: "GET", path: "/users/{userId}/profile" },
  { resource: "v1.users", methodName: "stop", http: "POST", path: "/users/{userId}/stop" },
  { resource: "v1.users", methodName: "watch", http: "POST", path: "/users/{userId}/watch" },

  // v1.users.drafts
  { resource: "v1.users.drafts", methodName: "create", http: "POST", path: "/users/{userId}/drafts" },
  { resource: "v1.users.drafts", methodName: "delete", http: "DELETE", path: "/users/{userId}/drafts/{id}" },
  { resource: "v1.users.drafts", methodName: "get", http: "GET", path: "/users/{userId}/drafts/{id}" },
  { resource: "v1.users.drafts", methodName: "list", http: "GET", path: "/users/{userId}/drafts" },
  { resource: "v1.users.drafts", methodName: "send", http: "POST", path: "/users/{userId}/drafts/send" },
  { resource: "v1.users.drafts", methodName: "update", http: "PUT", path: "/users/{userId}/drafts/{id}" },

  // v1.users.history
  { resource: "v1.users.history", methodName: "list", http: "GET", path: "/users/{userId}/history" },

  // v1.users.labels
  { resource: "v1.users.labels", methodName: "create", http: "POST", path: "/users/{userId}/labels" },
  { resource: "v1.users.labels", methodName: "delete", http: "DELETE", path: "/users/{userId}/labels/{id}" },
  { resource: "v1.users.labels", methodName: "get", http: "GET", path: "/users/{userId}/labels/{id}" },
  { resource: "v1.users.labels", methodName: "list", http: "GET", path: "/users/{userId}/labels" },
  { resource: "v1.users.labels", methodName: "patch", http: "PATCH", path: "/users/{userId}/labels/{id}" },
  { resource: "v1.users.labels", methodName: "update", http: "PUT", path: "/users/{userId}/labels/{id}" },

  // v1.users.messages
  { resource: "v1.users.messages", methodName: "batchDelete", http: "POST", path: "/users/{userId}/messages/batchDelete" },
  { resource: "v1.users.messages", methodName: "batchModify", http: "POST", path: "/users/{userId}/messages/batchModify" },
  { resource: "v1.users.messages", methodName: "delete", http: "DELETE", path: "/users/{userId}/messages/{id}" },
  { resource: "v1.users.messages", methodName: "get", http: "GET", path: "/users/{userId}/messages/{id}" },
  { resource: "v1.users.messages", methodName: "import", http: "POST", path: "/users/{userId}/messages/import" },
  { resource: "v1.users.messages", methodName: "insert", http: "POST", path: "/users/{userId}/messages" },
  { resource: "v1.users.messages", methodName: "list", http: "GET", path: "/users/{userId}/messages" },
  { resource: "v1.users.messages", methodName: "modify", http: "POST", path: "/users/{userId}/messages/{id}/modify" },
  { resource: "v1.users.messages", methodName: "send", http: "POST", path: "/users/{userId}/messages/send" },
  { resource: "v1.users.messages", methodName: "trash", http: "POST", path: "/users/{userId}/messages/{id}/trash" },
  { resource: "v1.users.messages", methodName: "untrash", http: "POST", path: "/users/{userId}/messages/{id}/untrash" },

  // v1.users.messages.attachments
  { resource: "v1.users.messages.attachments", methodName: "get", http: "GET", path: "/users/{userId}/messages/{messageId}/attachments/{id}" },

  // v1.users.settings
  { resource: "v1.users.settings", methodName: "getAutoForwarding", http: "GET", path: "/users/{userId}/settings/autoForwarding" },
  { resource: "v1.users.settings", methodName: "getImap", http: "GET", path: "/users/{userId}/settings/imap" },
  { resource: "v1.users.settings", methodName: "getLanguage", http: "GET", path: "/users/{userId}/settings/language" },
  { resource: "v1.users.settings", methodName: "getPop", http: "GET", path: "/users/{userId}/settings/pop" },
  { resource: "v1.users.settings", methodName: "getVacation", http: "GET", path: "/users/{userId}/settings/vacation" },
  { resource: "v1.users.settings", methodName: "updateAutoForwarding", http: "PUT", path: "/users/{userId}/settings/autoForwarding" },
  { resource: "v1.users.settings", methodName: "updateImap", http: "PUT", path: "/users/{userId}/settings/imap" },
  { resource: "v1.users.settings", methodName: "updateLanguage", http: "PUT", path: "/users/{userId}/settings/language" },
  { resource: "v1.users.settings", methodName: "updatePop", http: "PUT", path: "/users/{userId}/settings/pop" },
  { resource: "v1.users.settings", methodName: "updateVacation", http: "PUT", path: "/users/{userId}/settings/vacation" },

  // v1.users.settings.cse.identities
  { resource: "v1.users.settings.cse.identities", methodName: "create", http: "POST", path: "/users/{userId}/settings/cse/identities" },
  { resource: "v1.users.settings.cse.identities", methodName: "delete", http: "DELETE", path: "/users/{userId}/settings/cse/identities/{cseEmailAddress}" },
  { resource: "v1.users.settings.cse.identities", methodName: "get", http: "GET", path: "/users/{userId}/settings/cse/identities/{cseEmailAddress}" },
  { resource: "v1.users.settings.cse.identities", methodName: "list", http: "GET", path: "/users/{userId}/settings/cse/identities" },
  { resource: "v1.users.settings.cse.identities", methodName: "patch", http: "PATCH", path: "/users/{userId}/settings/cse/identities/{emailAddress}" },

  // v1.users.settings.cse.keypairs
  { resource: "v1.users.settings.cse.keypairs", methodName: "create", http: "POST", path: "/users/{userId}/settings/cse/keypairs" },
  { resource: "v1.users.settings.cse.keypairs", methodName: "disable", http: "POST", path: "/users/{userId}/settings/cse/keypairs/{keyPairId}:disable" },
  { resource: "v1.users.settings.cse.keypairs", methodName: "enable", http: "POST", path: "/users/{userId}/settings/cse/keypairs/{keyPairId}:enable" },
  { resource: "v1.users.settings.cse.keypairs", methodName: "get", http: "GET", path: "/users/{userId}/settings/cse/keypairs/{keyPairId}" },
  { resource: "v1.users.settings.cse.keypairs", methodName: "list", http: "GET", path: "/users/{userId}/settings/cse/keypairs" },
  { resource: "v1.users.settings.cse.keypairs", methodName: "obliterate", http: "POST", path: "/users/{userId}/settings/cse/keypairs/{keyPairId}:obliterate" },

  // v1.users.settings.delegates
  { resource: "v1.users.settings.delegates", methodName: "create", http: "POST", path: "/users/{userId}/settings/delegates" },
  { resource: "v1.users.settings.delegates", methodName: "delete", http: "DELETE", path: "/users/{userId}/settings/delegates/{delegateEmail}" },
  { resource: "v1.users.settings.delegates", methodName: "get", http: "GET", path: "/users/{userId}/settings/delegates/{delegateEmail}" },
  { resource: "v1.users.settings.delegates", methodName: "list", http: "GET", path: "/users/{userId}/settings/delegates" },

  // v1.users.settings.filters
  { resource: "v1.users.settings.filters", methodName: "create", http: "POST", path: "/users/{userId}/settings/filters" },
  { resource: "v1.users.settings.filters", methodName: "delete", http: "DELETE", path: "/users/{userId}/settings/filters/{id}" },
  { resource: "v1.users.settings.filters", methodName: "get", http: "GET", path: "/users/{userId}/settings/filters/{id}" },
  { resource: "v1.users.settings.filters", methodName: "list", http: "GET", path: "/users/{userId}/settings/filters" },

  // v1.users.settings.forwardingAddresses
  { resource: "v1.users.settings.forwardingAddresses", methodName: "create", http: "POST", path: "/users/{userId}/settings/forwardingAddresses" },
  { resource: "v1.users.settings.forwardingAddresses", methodName: "delete", http: "DELETE", path: "/users/{userId}/settings/forwardingAddresses/{forwardingEmail}" },
  { resource: "v1.users.settings.forwardingAddresses", methodName: "get", http: "GET", path: "/users/{userId}/settings/forwardingAddresses/{forwardingEmail}" },
  { resource: "v1.users.settings.forwardingAddresses", methodName: "list", http: "GET", path: "/users/{userId}/settings/forwardingAddresses" },

  // v1.users.settings.sendAs
  { resource: "v1.users.settings.sendAs", methodName: "create", http: "POST", path: "/users/{userId}/settings/sendAs" },
  { resource: "v1.users.settings.sendAs", methodName: "delete", http: "DELETE", path: "/users/{userId}/settings/sendAs/{sendAsEmail}" },
  { resource: "v1.users.settings.sendAs", methodName: "get", http: "GET", path: "/users/{userId}/settings/sendAs/{sendAsEmail}" },
  { resource: "v1.users.settings.sendAs", methodName: "list", http: "GET", path: "/users/{userId}/settings/sendAs" },
  { resource: "v1.users.settings.sendAs", methodName: "patch", http: "PATCH", path: "/users/{userId}/settings/sendAs/{sendAsEmail}" },
  { resource: "v1.users.settings.sendAs", methodName: "update", http: "PUT", path: "/users/{userId}/settings/sendAs/{sendAsEmail}" },
  { resource: "v1.users.settings.sendAs", methodName: "verify", http: "POST", path: "/users/{userId}/settings/sendAs/{sendAsEmail}/verify" },

  // v1.users.settings.sendAs.smimeInfo
  { resource: "v1.users.settings.sendAs.smimeInfo", methodName: "delete", http: "DELETE", path: "/users/{userId}/settings/sendAs/{sendAsEmail}/smimeInfo/{id}" },
  { resource: "v1.users.settings.sendAs.smimeInfo", methodName: "get", http: "GET", path: "/users/{userId}/settings/sendAs/{sendAsEmail}/smimeInfo/{id}" },
  { resource: "v1.users.settings.sendAs.smimeInfo", methodName: "insert", http: "POST", path: "/users/{userId}/settings/sendAs/{sendAsEmail}/smimeInfo" },
  { resource: "v1.users.settings.sendAs.smimeInfo", methodName: "list", http: "GET", path: "/users/{userId}/settings/sendAs/{sendAsEmail}/smimeInfo" },
  { resource: "v1.users.settings.sendAs.smimeInfo", methodName: "setDefault", http: "POST", path: "/users/{userId}/settings/sendAs/{sendAsEmail}/smimeInfo/{id}/setDefault" },

  // v1.users.threads
  { resource: "v1.users.threads", methodName: "delete", http: "DELETE", path: "/users/{userId}/threads/{id}" },
  { resource: "v1.users.threads", methodName: "get", http: "GET", path: "/users/{userId}/threads/{id}" },
  { resource: "v1.users.threads", methodName: "list", http: "GET", path: "/users/{userId}/threads" },
  { resource: "v1.users.threads", methodName: "modify", http: "POST", path: "/users/{userId}/threads/{id}/modify" },
  { resource: "v1.users.threads", methodName: "trash", http: "POST", path: "/users/{userId}/threads/{id}/trash" },
  { resource: "v1.users.threads", methodName: "untrash", http: "POST", path: "/users/{userId}/threads/{id}/untrash" },
];

// Derives the gmail_api_<group>_<method> tool name for a route.
...
// Builds a generic MCP tool for a single Gmail API v1 route. Path params
// (besides {userId}) become required string parameters; GET methods accept
// an optional `query` JSON object string, and POST/PUT/PATCH methods accept
// an optional `body` JSON object string sent as the request payload.
function apiTool(route) {
  const pathParams = [...route.path.matchAll(/\{(\w+)\}/g)]
    .map(m => m[1])
    .filter(p => p !== "userId");

  const parameters = {
    userId: { type: "string", description: "Gmail user ID. Use 'me' for the authenticated user (default)." },
  };
  for (const p of pathParams) {
    parameters[p] = { type: "string", description: `Path parameter "${p}" for ${route.resource}.${route.methodName}` };
  }
  if (route.http === "GET") {
    parameters.query = { type: "string", description: "Optional JSON object of query string parameters, e.g. {\"maxResults\":10,\"q\":\"is:unread\"}" };
  }
  if (route.http === "POST" || route.http === "PUT" || route.http === "PATCH") {
    parameters.body = { type: "string", description: "JSON object request body, per the Gmail API v1 reference for this method" };
  }
  ...
  return {
    ...
    handler: async (args = {}) => {
      ...
      const data = await gmailRequest(route.http, path, body);
