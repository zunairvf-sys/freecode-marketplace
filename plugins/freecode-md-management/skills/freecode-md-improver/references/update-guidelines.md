# FREECODE.md Update Guidelines

## Core Principle

Only add information that will genuinely help future FreeCode sessions. The context window is precious - every line must earn its place.
...
- [ ] Would a new FreeCode session find this helpful?
