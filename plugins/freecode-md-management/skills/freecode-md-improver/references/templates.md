...
Describe the project structure so FreeCode understands where things live.
...
List important files that FreeCode should know about.
...
4. **Be useful**: Would this help a new FreeCode session understand the project?
