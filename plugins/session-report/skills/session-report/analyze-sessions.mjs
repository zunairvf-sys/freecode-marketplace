 ...
 * analyze-sessions.js
 *
 * Scans ~/.freecode/projects/**.jsonl transcript files and reports token usage,
...
const ROOT = flag('--dir', path.join(os.homedir(), '.freecode', 'projects'))
...
function printText({ overall, perProject, perSubagent, perSkill }) {
  ...
  line()
  line(`FreeCode Code session analysis — ${ROOT}`)
