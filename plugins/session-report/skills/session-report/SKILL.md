---
name: session-report
description: Generate an explorable HTML report of FreeCode Code session usage (tokens, cache, subagents, skills, expensive prompts) from ~/.freecode/projects transcripts.
---

# Session Report

Produce a self-contained HTML report of FreeCode Code usage and save it to the current working directory.
