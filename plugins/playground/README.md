...
The user adjusts controls, explores visually, then copies the generated prompt back into FreeCode.
...
Add this plugin to your FreeCode Code configuration to enable the playground skill.
