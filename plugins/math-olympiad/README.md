...
[freecode monorepo](https://github.com/freecodes/freecode/tree/staging/sandbox/sandbox/ralph/math_skills/eval_harness).

## Install

```
/plugin install math-olympiad@freecode-plugins-official
```
