...
### Layer 2: freecode Code Memory (Quick Access)
- **Path:** `~/.freecode/projects/*/memory/`
...
- Always update freecode Code memory for quick access
...
- Sources: freecode session files, Codex sessions, other agent sessions
...
- freecode/ChatGPT/Grok conversation exports
- Browser bookmarks
