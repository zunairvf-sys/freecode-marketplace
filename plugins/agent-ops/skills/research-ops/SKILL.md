---
name: research-ops
description: Evidence-first current-state research workflow for FreeCode. Use when the user wants fresh facts, comparisons, enrichment, or a recommendation built from current public evidence and any supplied local context.
origin: FreeCode
---
