...
description: "Design task-local harnesses, eval gates, and reusable skill extraction for freecode dynamic workflow mode and other adaptive agent harnesses."
origin: FreeCode
---
...
- The user mentions dynamic workflows, custom harnesses, harness-per-task, adaptive workflows, or freecode Code dynamic workflow mode.
...
If the repo has ECC2 state enabled, prefer adding or reading checkpoints through the FreeCode control pane or state-store-backed scripts instead of scattering untracked notes.
