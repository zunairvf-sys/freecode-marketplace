...
The script audits the current working directory by default and auto-detects whether the target is the FreeCode repo itself or a consumer project using FreeCode.
...
6. Suggested FreeCode skills to apply next.
