...
Create hook rules to prevent unwanted freecode Code behaviors by analyzing conversation patterns or explicit user instructions.
...
For each approved rule, create a file at `.freecode/hookify.{name}.local.md`:
