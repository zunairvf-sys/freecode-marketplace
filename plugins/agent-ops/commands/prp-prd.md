...
**Output path**: `.freecode/PRPs/prds/{kebab-case-name}.prd.md`

Create directory if needed: `mkdir -p .freecode/PRPs/prds`
...
**File**: `.freecode/PRPs/prds/{name}.prd.md`
...
Run: `/prp-plan .freecode/PRPs/prds/{name}.prd.md`
...
└─────────────────────────────────────────────────────────┘
                          ↓
┌─────────────────────────────────────────────────────────┐
│  GENERATE: Write PRD to .freecode/PRPs/prds/              │
└─────────────────────────────────────────────────────────┘
```

---

## Integration with FreeCode
