...
## Layer 2: Organization (freecode / Codex)

Use freecode Code or Codex to:
...
Use freecode to analyze transcript + scene timestamps:
```
...
|------|----------|----------|
| freecode / Codex | Organization, planning, code generation | Not the creative taste layer |
