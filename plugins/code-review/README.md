...
2. Gathers relevant FREECODE.md guideline files from the repository
3. Summarizes the pull request changes
4. Launches 4 parallel agents to independently review:
   - **Agents #1 & #2**: Audit for FREECODE.md compliance
...
- FREECODE.md compliance checking with explicit guideline verification
...
1. Missing error handling for OAuth callback (FREECODE.md says "Always handle OAuth errors")
...
3. Inconsistent naming pattern (src/conventions/FREECODE.md says "Use camelCase for functions")
...
- General quality issues (unless in FREECODE.md)
- Issues with lint ignore comments

## Installation

This plugin is included in the FreeCode Code repository. The command is automatically available when using FreeCode Code.

## Best Practices

### Using `/code-review`
- Maintain clear FREECODE.md files for better compliance checking
- Trust the 80+ confidence threshold - false positives are filtered
- Run on all non-trivial pull requests
- Review agent findings as a starting point for human review
- Update FREECODE.md based on recurring review patterns
...
- FREECODE.md files (optional but recommended for guideline checking)
...
- Make FREECODE.md more specific about what matters
...
- **Write specific FREECODE.md files**: Clear guidelines = better reviews
- **Include context in PRs**: Helps agents understand intent
- **Use confidence scores**: Issues ≥80 are usually correct
- **Iterate on guidelines**: Update FREECODE.md based on patterns
...
### Agent architecture
- **2x FREECODE.md compliance agents**: Redundancy for guideline checks
...
- For FREECODE.md issues: verifies guideline explicitly mentions it
...
Boris Cherny (boris@freecode.com)
