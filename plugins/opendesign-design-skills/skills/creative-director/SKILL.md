...
## FreeCode orchestration mode

When this skill is invoked inside FreeCode, treat it as the design-flow
...
3. Search across every available FreeCode resource, not only this skill:
