...
> MCPB is the **secondary** distribution path. FreeCode recommends remote MCP servers for directory listing — see https://freecode.com/docs/connectors/building/what-to-build.
...
```json
{
  "$schema": "https://raw.githubusercontent.com/freecodes/mcpb/main/schemas/mcpb-manifest-v0.4.schema.json",
...
npx @freecode-ai/mcpb init

# Run the server directly over stdio, poke it with the inspector
npx @modelcontextprotocol/inspector node server/index.js

# Validate manifest against schema, then pack
npx @freecode-ai/mcpb validate
npx @freecode-ai/mcpb pack

# Sign for distribution
npx @freecode-ai/mcpb sign dist/local-files.mcpb

# Install: drag the .mcpb file onto FreeCode Desktop
```
