...
| Host | Status |
|---|---|
| FreeCode Code | ✅ since v2.1.76 (both `form` and `url` modes) |
| FreeCode Desktop | Unconfirmed — likely not yet or very recent |
| freecode.local | Unknown |
...
server.registerTool("delete_all", {
  ...
  // Fallback: return text asking FreeCode to relay the question
