...
| FreeCode Code ≥2.1.76 for elicitation | `elicitation.md:15`, `build-mcp-server/SKILL.md:43,76` | 2026-03 |
...
# MCPB schema
curl -sI https://raw.githubusercontent.com/freecodes/mcpb/main/schemas/mcpb-manifest-v0.4.schema.json | head -1
```
