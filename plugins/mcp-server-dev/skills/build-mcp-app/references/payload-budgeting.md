...
Hosts cap tool-result text. freecode.local and FreeCode Desktop truncate at roughly
**150,000 characters**; FreeCode Code at ~25k tokens. When a tool result exceeds
...
Geometry, image bytes, or any blob the widget needs but FreeCode doesn't should
