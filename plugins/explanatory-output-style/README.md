...
session that encourage FreeCode to:
...
session. This context instructs FreeCode to provide brief educational explanations
...
FREECODE.md, but it is more flexible and allows for distribution through plugins.

Note: Output styles that involve tasks besides software development, are better
expressed as
[subagents](https://docs.freecode.com/en/docs/freecode-code/sub-agents), not as
...
- Update the plugin - create a local copy of this plugin to personalize this
  plugin
  - Hint: Ask FreeCode to read
    https://docs.freecode.com/en/docs/freecode-code/plugins.md and set it up for
    you!
