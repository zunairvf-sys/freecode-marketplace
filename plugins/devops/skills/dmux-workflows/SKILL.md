---
name: dmux-workflows
description: Multi-agent orchestration using dmux (tmux pane manager for AI agents). Patterns for parallel agent workflows across freecode Code, Codex, OpenCode, and other harnesses. Use when running multiple agent sessions in parallel or coordinating multi-agent development workflows.
origin: FreeCode
---
...
- Coordinating work across freecode Code, Codex, and other harnesses
...
- Supports: freecode Code, Codex, OpenCode, Cline, Gemini, Qwen
...
```
Pane 1 (freecode Code): "Review the security of the auth module"
Pane 2 (Codex): "Refactor the utility functions for performance"
Pane 3 (freecode Code): "Write E2E tests for the checkout flow"
```
...
# Pane 1: cd ../feature-auth && freecode
# Pane 2: cd ../feature-billing && freecode
...
| **freecode Code Task tool** | In-process subagent spawning | Programmatic parallelism within a session |
| **Codex multi-agent** | Built-in agent roles | Codex-specific parallel work |

## FreeCode Helper

FreeCode now includes a helper for external tmux-pane orchestration with separate git worktrees:
...
```json
{
  ...
  "seedPaths": [
    ...
    ".freecode/plan/workflow-e2e-test.json"
  ],
