...
4. Generate command files in `.freecode/commands/`
5. Generate script files in `.freecode/scripts/`
6. **Update project freecode.md** with PM2 info (see below)
7. **Display completion summary** with terminal commands

---

## Post-Init: Update freecode.md

After generating files, append PM2 section to project's `freecode.md` (create if not exists):
...
**freecode Commands:** /pm2-all, /pm2-all-stop, /pm2-{port}, /pm2-{port}-stop, /pm2-logs, /pm2-status
